...
private:
	...
	void		_set_first_name(std::string);
	void		_set_last_name(std::string);
	void		_set_nickname(std::string);
	void		_set_phone_number(std::string);
	void		_set_darkest_secret(std::string);
